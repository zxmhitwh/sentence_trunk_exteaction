...
namespace NLP
{
    class TrieBase {
        ...
        public:
            ...
            virtual DictStateT matchLongest(const DictKeyT* key, int keyLen, int& matchedLen) = 0;
    ...
    class DoubleArrayTrie : public TrieBase {
        ...
        virtual DictStateT matchLongest(const DictKeyT* key, int keyLen, int& matchedLen);
        ...
        virtual DictStateT _matchLongest(const DictKeyT* key, int keyLen, int& matchedLen);
        ...
        void    relocate(DictStateT s, int b, int keys[], int numKeys);
    ...
    class DoubleTrie : public TrieBase {
        public:
